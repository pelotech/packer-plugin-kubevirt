...
type FlatConfig struct {
	...
	KubernetesNodeAutoscaler        *k8s.NodeAutoscaler `mapstructure:"kubernetes_node_autoscaler" required:"false" cty:"kubernetes_node_autoscaler" hcl:"kubernetes_node_autoscaler"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"kubernetes_node_autoscaler":   &hcldec.AttrSpec{Name: "kubernetes_node_autoscaler", Type: cty.String, Required: false},
