...
replace (
	...
	k8s.io/api v0.29.1 => k8s.io/api v0.26.10
	k8s.io/apimachinery v0.29.1 => k8s.io/apimachinery v0.26.10
	k8s.io/client-go v12.0.0+incompatible => k8s.io/client-go v0.26.10
)
